          ...
          <div className="bg-group-amber-soft px-5 py-10 sm:px-8 lg:px-30">
            <div className="mx-auto space-y-5">
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                ...
                <ProposalCard title="Reparación de techo" amount="Total: $44.000 - Individual: $11.000" description="Filtración detectada en el dormitorio principal" assigned={["Rocio", "Pablo", "Lucia"]} owner="Yo" status="accepted" />
              </div>
            </div>
          </div>
        </section>
